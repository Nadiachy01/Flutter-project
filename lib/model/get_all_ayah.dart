...
//
//     final getAllAyah = getAllAyahFromJson(jsonString);

import 'package:meta/meta.dart';
import 'dart:convert';

GetAllAyah getAllAyahFromJson(String str) => GetAllAyah.fromJson(json.decode(str));

String getAllAyahToJson(GetAllAyah data) => json.encode(data.toJson());
...
class GetAllAyah {
  ...
  factory GetAllAyah.fromJson(Map<String, dynamic> json) => GetAllAyah(
    code: json["code"],
    status: json["status"],
