...
// import 'dart:convert';
//
// GetAllTranslation getAllTranslationFromJson(String str) => GetAllTranslation.fromJson(json.decode(str));
//
// String getAllTranslationToJson(GetAllTranslation data) => json.encode(data.toJson());
//
...
List<GetAllTranslation> getAllTranslationFromJson(String str) => List<GetAllTranslation>.from(json.decode(str).map((x) => GetAllTranslation.fromJson(x)));

String getAllTranslationToJson(List<GetAllTranslation> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
